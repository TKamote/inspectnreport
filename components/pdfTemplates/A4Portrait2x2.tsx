...
export const generateA4Portrait2x2 = (
  ...
  for (let pageIndex = 0; pageIndex < totalPages; pageIndex++) {
    ...
    pageCards.forEach((card, cardIndex) => {
      ...
      if (card.photo) {
        try {
          console.log(`Processing image for card ${cardIndex + 1}`);
...
// Remove the browser-only download function and replace with React Native compatible version
export const downloadA4Portrait2x2PDF = async (
  ...
  try {
    ...
    // Return the base64 data instead of trying to save directly
    return base64Data;
